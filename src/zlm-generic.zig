    ...
    return struct {
        ...
        pub const Mat4 = extern struct {
            ...
            pub fn createLook(eye: Vec3, direction: Vec3, up: Vec3) Self {
                ...
                result.fields[1][2] = -.y;
                result.fields[2][2] = -.z;
                result.fields[3][0] = -ec3.dot(s, eye);
                result.fields[3][1] = -ec3.dot(u, eye);
            ...
            pub fn createAngleAxis(axis: Vec3, angle: Real) Self {
                ...
                return Self{
                    .fields = [4][4]Real{
                        [4]Real{ cos + x * x * (1 - cos), * (1 - cos) + z * sin, x * z 1 - cos) - y * sin, 0 },
                        [4]Real{ y * x * (1 - cos) - z * sin,os + y * y * (1 - cos), y 1 - cos) + x * sin, 0 },
                        [4]Real{ z * x * (1 - cos) + y * sin, * y * (1 - cos) - x * sin, co z * z * (1 - cos), 0 },
                        [4]Real{ 0, 
                    },
                };
            }
